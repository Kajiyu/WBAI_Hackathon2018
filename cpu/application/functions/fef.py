...
class FEF(object):
    ...
    def __call__(self, inputs):
        ...
        saliency_map, optical_flow, flow_salicency_map, saliency_gradient_map = inputs['from_lip']
        vgg_feature = inputs['from_vc']
        ...
        return dict(to_pfc=None,
                    to_bg=(vgg_feature, saliency_map, optical_flow, flow_salicency_map, saliency_gradient_map),
                    to_sc=output)
